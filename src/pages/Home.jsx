      ...
      <div class="flex items-center justify-center min-h-[90vh] p-8">
        <div class="bg-white p-8 rounded-lg shadow-md max-w-lg w-full">
          ...
          <p class="text-lg text-gray-700 text-center">
            Fun fact: Blocks are inspired by real structures used in Web 3 Based Apps, where they hold a vast amount of data. While these digital blocks are more engaging, they share the same principles of organization and tracking.
          </p>
        </div>
      </div>
    </>
